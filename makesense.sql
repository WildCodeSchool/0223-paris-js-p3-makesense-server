...
CREATE TABLE IF NOT EXISTS `makesense`.`user` (
  ...
  `affiliated_site` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE INDEX `fk_user_job` ON `makesense`.`user` (`job_id` ASC) VISIBLE;

CREATE INDEX `fk_user_role1` ON `makesense`.`user` (`role_id` ASC) VISIBLE;
...
CREATE INDEX `fk_post_user1` ON `makesense`.`post` (`user_id` ASC) VISIBLE;
...
CREATE INDEX `fk_user_alert_alert1` ON `makesense`.`user_alert` (`alert_id` ASC) VISIBLE;

CREATE INDEX `fk_user_alert_user1` ON `makesense`.`user_alert` (`user_id` ASC) VISIBLE;
...
CREATE INDEX `fk_user_participant_user1` ON `makesense`.`user_participant` (`user_id` ASC) VISIBLE;

CREATE INDEX `fk_user_participant_post1` ON `makesense`.`user_participant` (`post_id` ASC) VISIBLE;
...
CREATE INDEX `fk_user_post_avis_user1` ON `makesense`.`user_post_avis` (`user_id` ASC) VISIBLE;

CREATE INDEX `fk_user_post_avis_post1` ON `makesense`.`user_post_avis` (`post_id` ASC) VISIBLE;
...
CREATE INDEX `fk_user_post_vote_user1` ON `makesense`.`user_post_vote` (`user_id` ASC) VISIBLE;

CREATE INDEX `fk_user_post_vote_post1` ON `makesense`.`user_post_vote` (`post_id` ASC) VISIBLE;
